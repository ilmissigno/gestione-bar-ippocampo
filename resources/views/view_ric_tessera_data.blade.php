...
<div class="container my-5 py-5">
  <h2 class="text-white text-left mb-5">Visualizza le Ricariche della Tessera per Data</h2>
  <div class="row">
    <div class="col-12" style="background-color: rgba(255, 255, 255, 0.5)">
      <form method="POST" action="{{ route('view_ric_tessera_data') }}">
        @csrf
        <div class="form-group p-3">
          <div class="row">
            <div class="col-3">
              <label>Tessera :</label>
              <input type="text" class="form-control" name="codtess">
            </div>
            <div class="col-3">
              <label>Data : </label>
              <input type="datetime-local" class="form-control" id="dataric" name="data_ric">
            </div>
            <div class="col-2">
              <br>
        ...
        <table class="table table-dark text-white" style="background: rgba(0,0,0,0.7)">
          ...
          @foreach ($ricariche as $a)
              <tr>
                ...
                <td class="font-weight-bold text-capitalize">{{$a->tessera->socio->nome}} {{$a->tessera->socio->cognome}}</td>
