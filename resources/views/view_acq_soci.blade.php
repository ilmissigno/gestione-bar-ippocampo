...
<div class="container my-5 py-5">
  <h2 class="text-white text-left mb-5">Visualizza gli Acquisti del Socio</h2>
  <div class="row">
    <div class="col-12" style="background-color: rgba(255, 255, 255, 0.5)">
      <form method="POST" action="{{ route('inventario_acquisti/view_acq_soci') }}">
        @csrf
        ...
        <table class="table table-dark text-white" style="background: rgba(0,0,0,0.7)">
          <thead>
            <tr>
              ...
              <th scope="col" class="font-weight-light text-uppercase">Data di Acquisto</th>
          ...
          @foreach ($acq as $a)
              <tr>
                ...
                <td class="font-weight-bold">{{$a->dataacq}}</td>
